...
async function buildAndWriteEPCI(simplifiedCommunes, precision) {
...
async function buildAndWriteDepartements(simplifiedCommunes, precision) {
...
async function buildAndWriteRegions(simplifiedCommunes, precision) {
...
async function buildAndWriteCommunes(simplifiedCommunes, precision) {
...
async function buildAndWriteArrondissements(simplifiedArrondissements, precision) {
