...
ogr2ogr -f GeoJSON -lco WRITE_NAME=NO \
        ...
        98412.geojson  \
        -dialect SQLite \
        -sql "SELECT cast('98412' AS text) AS insee, cast('Archipel des Kerguelen' AS text) AS nom, cast('' AS text) AS wikipedia, Area(ST_Union(geometry), TRUE) / 10000 AS surf_ha, ST_Union(geometry) AS geometry FROM (SELECT ST_BuildArea(geometry) AS geometry FROM (SELECT linemerge(geometry) AS geometry FROM (SELECT ST_collect(geometry) AS geometry FROM \"98412\" WHERE ST_GeometryType(geometry) = 'LINESTRING') AS foo) AS bar UNION ALL SELECT ST_collect(geometry) AS geometry FROM \"98412\" WHERE ST_GeometryType(geometry) = 'POLYGON') AS baz"
...
ogr2ogr -f GeoJSON \
        ...
        98413.geojson \
        -dialect SQLite \
        -sql "SELECT cast('98413' AS text) AS insee, cast('Archipel des Crozet' AS text) AS nom, cast('' AS text) AS wikipedia, Area(ST_Union(geometry), TRUE) / 10000 AS surf_ha, ST_Union(geometry) AS geometry FROM (SELECT ST_BuildArea(geometry) AS geometry FROM (SELECT linemerge(geometry) AS geometry FROM (SELECT ST_collect(geometry) AS geometry FROM \"98413\" WHERE ST_GeometryType(geometry) = 'LINESTRING') AS foo) AS bar UNION ALL SELECT ST_collect(geometry) AS geometry FROM \"98413\" WHERE ST_GeometryType(geometry) = 'POLYGON') AS baz"
...
ogr2ogr -f GeoJSON \
        ...
        98414.geojson \
        -dialect SQLite \
        -sql "SELECT cast('98414' AS text) AS insee, cast('La Terre-Adélie' AS text) AS nom, cast('' AS text) AS wikipedia, Area(ST_Union(geometry), TRUE) / 10000 AS surf_ha, ST_Union(geometry) AS geometry FROM (SELECT ST_BuildArea(geometry) AS geometry FROM (SELECT linemerge(geometry) AS geometry FROM (SELECT ST_collect(geometry) AS geometry FROM \"98414\" WHERE ST_GeometryType(geometry) = 'LINESTRING') AS foo) AS bar UNION ALL SELECT ST_collect(geometry) AS geometry FROM \"98414\" WHERE ST_GeometryType(geometry) = 'POLYGON') AS baz"
...
ogr2ogr -f GeoJSON \
        ...
        -dialect SQLite \
        -sql "SELECT cast('98415_bassas_da_india' AS text) AS insee, 'Bassas Da India' AS nom, cast('' AS text) AS wikipedia, Area(ST_Union(geometry), TRUE) / 10000 AS surf_ha, ST_Union(geometry) AS geometry FROM (SELECT ST_BuildArea(geometry) AS geometry FROM (SELECT linemerge(geometry) AS geometry FROM (SELECT ST_collect(geometry) AS geometry FROM \"98415_bassas_da_india\" WHERE ST_GeometryType(geometry) = 'LINESTRING') AS foo) AS bar UNION ALL SELECT ST_collect(geometry) AS geometry FROM \"98415_bassas_da_india\" WHERE ST_GeometryType(geometry) = 'POLYGON') AS baz"
...
ogr2ogr -f GeoJSON \
        ...
        -dialect SQLite \
        -sql "SELECT cast('98415_ile_europa' AS text) AS insee, 'Île Europa' AS nom, cast('' AS text) AS wikipedia, Area(ST_Union(geometry), TRUE) / 10000 AS surf_ha, ST_Union(geometry) AS geometry FROM (SELECT ST_BuildArea(geometry) AS geometry FROM (SELECT linemerge(geometry) AS geometry FROM (SELECT ST_collect(geometry) AS geometry FROM \"98415_ile_europa\" WHERE ST_GeometryType(geometry) = 'LINESTRING') AS foo) AS bar UNION ALL SELECT ST_collect(geometry) AS geometry FROM \"98415_ile_europa\" WHERE ST_GeometryType(geometry) = 'POLYGON') AS baz"
...
ogr2ogr -f GeoJSON \
        ...
        -dialect SQLite \
        -sql "SELECT cast('98415_iles_glorieuses' AS text) AS insee, 'Îles glorieuses' AS nom, cast('' AS text) AS wikipedia, Area(ST_Union(geometry), TRUE) / 10000 AS surf_ha, ST_Union(geometry) AS geometry FROM (SELECT ST_BuildArea(geometry) AS geometry FROM (SELECT linemerge(geometry) AS geometry FROM (SELECT ST_collect(geometry) AS geometry FROM \"98415_iles_glorieuses\" WHERE ST_GeometryType(geometry) = 'LINESTRING') AS foo) AS bar UNION ALL SELECT ST_collect(geometry) AS geometry FROM \"98415_iles_glorieuses\" WHERE ST_GeometryType(geometry) = 'POLYGON') AS baz"
...
ogr2ogr -f GeoJSON \
        ...
        -dialect SQLite \
        -sql "SELECT cast('98415_ile_juan_de_nova' AS text) AS insee, 'Île Juan de Nova' AS nom, cast('' AS text) AS wikipedia, Area(ST_Union(geometry), TRUE) / 10000 AS surf_ha, ST_Union(geometry) AS geometry FROM (SELECT ST_BuildArea(geometry) AS geometry FROM (SELECT linemerge(geometry) AS geometry FROM (SELECT ST_collect(geometry) AS geometry FROM \"98415_ile_juan_de_nova\" WHERE ST_GeometryType(geometry) = 'LINESTRING') AS foo) AS bar UNION ALL SELECT ST_collect(geometry) AS geometry FROM \"98415_ile_juan_de_nova\" WHERE ST_GeometryType(geometry) = 'POLYGON') AS baz"
...
ogr2ogr -f GeoJSON \
        ...
        -dialect SQLite \
        -sql "SELECT cast('98415_ile_tromelin' AS text) AS insee, 'Île Tromelin' AS nom, cast('' AS text) AS wikipedia, Area(ST_Union(geometry), TRUE) / 10000 AS surf_ha, ST_Union(geometry) AS geometry FROM (SELECT ST_BuildArea(geometry) AS geometry FROM (SELECT linemerge(geometry) AS geometry FROM (SELECT ST_collect(geometry) AS geometry FROM \"98415_ile_tromelin\" WHERE ST_GeometryType(geometry) = 'LINESTRING') AS foo) AS bar UNION ALL SELECT ST_collect(geometry) AS geometry FROM \"98415_ile_tromelin\" WHERE ST_GeometryType(geometry) = 'POLYGON') AS baz"
...
ogr2ogr -f GeoJSON \
        ...
        -dialect SQLite \
        -sql "SELECT cast('98415' AS text) AS insee, cast('Îles Éparses de l''océan Indien' AS text) AS nom, 'fr:Îles Éparses de l''océan Indien' AS wikipedia, Area(ST_Union(geometry), TRUE) / 10000 AS surf_ha, ST_Union(geometry) AS geometry FROM \"98415\""
